...
export const UserOptions = ({ completeAccount, sideBarClose, userAccount, disconnect, warning, account, type }) => {
  return (
    <>
      <Visual label={'Welcome!'} element={'popup-header'} customStyles={{ width: '100%' }} onClick={sideBarClose} />
