            ...
            <div className="trade-left-side-body-inner scroll">
              <div className="trade-left-side-item">
                ...
                <Tabs
                  ...
                  activeTab={tradeTypeFormActive}
                  tabsData={tradeTypeFormTabs}
                />
          ...
          <div className="trade-middle-side-bottom">
            <div className="trade-middle-side-bottom-half">
              <Tabs
                ...
                activeTab={myTradeType}
                tabsData={myTradeTypeTabs}
              />
              <div className="trade-bottom-side-ttl">
                <div className="trade-right-th txt-left">Price ({subCurrency})</div>
                <div className="trade-right-th">Amount ({mainCurrency})</div>
                <div className="trade-right-th">Time</div>
              </div>
              <div className="trade-middle-side-bottom-content scroll">
                {bottomSideElements.map((item, index) => {
                  return (
                    <div
                      key={index}
                      className={`trade-right-td-item trade-bottom-td-item ${
                        item.rise ? "green" : "red"
                      }`}
                    >
                      <div className="trade-right-td txt-left">{item.price}</div>
                      <div className="trade-right-td">{item.amount}</div>
                      <div className="trade-right-td">{item.time}</div>
                    </div>
                  );
                })}
              </div>
            ...
            <div className="trade-middle-side-bottom-half">
                ...
                <div className="trade-search-slider_next-container">
                  <div className="trade-search-slider_next">
                    ...
                    >
                      <g>
                        <path
                          d="M8.33337 5.70095L12.161 9.52859C12.613 9.98063 12.613 10.7203 12.161 11.1724L8.33337 15"
                          stroke="white"
                          strokeWidth="1.5"
                          strokeMiterlimit="10"
                          strokeLinecap="round"
                  ...
                  >
                    {currencies.map((item, index) => (
                      <SwiperSlide key={index}>
                        <div className="trade-search-slider_btn">{item.name}</div>
                      </SwiperSlide>
                    ))}
                  </Swiper>
                </div>
              ...
              <div className="trade-bottom-side-ttl">
                <div className="trade-right-th txt-left">
                  ...
                  >
                    <path
                      d="M0.666626 3.66634L3.99996 0.333008L7.33329 3.66634H0.666626Z"
                      fill="white"
                    />
                    <path
                      d="M0.666626 6.33268L3.99996 9.66602L7.33329 6.33268H0.666626Z"
                      fill="white"
                    />
                  </svg>
                </div>
        ...
        <div className="trade-right-side">
          <div className="trade-right-side-body">
            <div className="trade-right-side-ttl">
              <div className="trade-right-th txt-left">Price ({subCurrency})</div>
              <div className="trade-right-th">Amount ({mainCurrency})</div>
              <div className="trade-right-th">Total</div>
            </div>
                ...
                {rightSideRedElements.map((item, index) => {
                  return (
                    <div
                      key={item + index}
                      onMouseLeave={() => {
                        setOrderBookInfoIndex(null),
                          setOrderBookInfoStatus(false),
                          setOrderBookInfoColor(null);
                      }}
                      onMouseEnter={(e) => {
                        handleRightElementHover(e, index, "red");
                      }}
                      className="trade-right-td-item red"
                    >
                      <div
                        className="trade-right-td-line"
                        style={{ width: `${item.percent}%` }}
                      ></div>
                      <div
                        className={`trade-right-td-select ${
                          orderBookInfoColor == "red" && index >= orderBookInfoIndex
                            ? "active"
                            : ""
                        } ${
                          orderBookInfoColor == "red" && index == orderBookInfoIndex
                      ...
                      <div className="trade-right-td txt-left">{item.price}</div>
                      <div className="trade-right-td">{item.amount}</div>
                      <div className="trade-right-td">{item.total}</div>
                    </div>
                  );
                })}
              </div>
            ...
            <div className="trade-right-side-ttl">
              <div className="trade-right-side-price red">
                ...
                >
                  <path
                    d="M9.77223 4.41569L7.47863 2.12208L6.07817 0.714481C5.79282 0.429562 5.40606 0.269531 5.00282 0.269531C4.59957 0.269531 4.21281 0.429562 3.92746 0.714481L0.226255 4.41569C-0.259618 4.90156 0.0904962 5.73041 0.769289 5.73041H9.2292C9.91514 5.73041 10.2581 4.90156 9.77223 4.41569Z"
                    fill="#67BE7A"
                  />
                </svg>
              </div>
                ...
                {rightSideGreenElements.map((item, index) => {
                  return (
                    <div
                      ...
                      onMouseEnter={(e) => {
                        handleRightElementHover(e, index, "green");
                      }}
                      className="trade-right-td-item green"
                    >
                      <div
                        className="trade-right-td-line"
                        style={{ width: `${item.percent}%` }}
                      ...
                      <div
                        className={`trade-right-td-select ${
                          orderBookInfoColor == "green" && index <= orderBookInfoIndex
                            ? "active"
                            : ""
                        } ${
                          orderBookInfoColor == "green" && index == orderBookInfoIndex
