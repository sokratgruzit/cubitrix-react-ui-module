          ...
          <div className="item">
            <div className={"item-inner"}>
              ...
              <input
                ...
                placeholder="0.0000"
              />
              <div className="frame">ETH</div>
            </div>
            <div className="sub-item">USD</div>
          </div>
          <div className="item">
            <div className="item-inner">
              <p>
                Limit Price <span className="frame-row">USD</span>
              </p>
              <input
                className="input-area input-b"
                type="text"
                placeholder="0.0000"
              />
            </div>
