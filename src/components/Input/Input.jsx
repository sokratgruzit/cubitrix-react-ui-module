    ...
    if(props.type === 'default') {
        element = (
            <div  style={props.customStyles} className={`${props.className} input-group`}>
                {props.label || props.subLabel ? ( <p className='input-group-title font-12'>{props.label}<span className='font-12'>{props.subLabel}</span></p> ) : ''}
                <input onChange={props.onChange} value={props.value} style={props.icon ? {paddingRight: '43px'} : {paddingRight: '16px'}} className='form-control' type={!cover && props.inputType === 'password' ? 'password' : 'text'} placeholder={props.placeholder} />
                <span>
                    {props.inputType === 'password' ? (
                        <div onClick={coverHandler}>
                            {cover ? (

                                <svg style={{top: props.label || props.subLabel ? '30.5px' : '8px'}} className={'input-group-icon'} width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <svg style={{top: props.label || props.subLabel ? '30.5px' : '8px'}}  className={'input-group-icon'} width="18" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
