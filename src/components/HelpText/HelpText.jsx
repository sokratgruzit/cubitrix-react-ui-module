        ...
        <>
            ...
            {props.type === 'warning' ? (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M11.9987 9.45731V13.2761" stroke="#FFA726" strokeWidth="1.2" strokeMiterlimit="10" strokeLinecap="square"/>
                    ...
                    <div className='row'>
                        ...
                        <div className='close-btn'>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M9.17004 14.83L14.83 9.17" stroke="#6A6D76" strokeidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M14.83 14.83L9.17004 9.17" stroke="#6A6D76" strokeidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                        </div>
                    </div>
                    <div className='text'>
                        <p>
                            ...
                            <span className='btn'>
                                {/* <Button
                                    ...
                                    // i need type of this button i have in ui
                                /> */}
                            </span>
                        </p>
                    </div>
