...
export const TopUpDashboard = ({
  ...
  const handlePurchase = () => {
    ...
    setTokenError(null)
    handlePurchaseEvent(selectedMethod, Number(tokenAmount) * Number(exchangeRate) + Number(tranasctionFee))
    // setOpenPopup(true);
  }
  ...
  return (
    <div className='topupDashboard_main'>
      ...
      <div className='topupDashboard_title-container'>
        <p className='topupDashboard_title'>1. Select the payment method and calculate token price</p>
      ...
      <div className='topupDashboard_title-bottomContainer'>
        <div className='topupDashboard_bottom-left'>
          <p className='topupDashboard_title'>2. Set amount of CPL tokens you would like to purchase</p>
          <p className='topupDashboard_info'>
            Enter the amount you would like to contribute in order to calculate the amount of tokens you will receive.
            The calculator below helps to convert the required quantity of tokens into the amount of your selected
            currency.
          </p>
