    ...
    <div className={"filter-box-container"} style={customStyles}>
      <div className={`filter-box ${showSearchBox && "show-filters"}`}>
        ...
        >
          ...
          >
            <path
              d="M18.3334 6.0415H13.3334C12.9917 6.0415 12.7084 5.75817 12.7084 5.4165C12.7084 5.07484 12.9917 4.7915 13.3334 4.7915H18.3334C18.675 4.7915 18.9584 5.07484 18.9584 5.4165C18.9584 5.75817 18.675 6.0415 18.3334 6.0415Z"
              fill="white"
            />
            <path
              d="M5.00002 6.0415H1.66669C1.32502 6.0415 1.04169 5.75817 1.04169 5.4165C1.04169 5.07484 1.32502 4.7915 1.66669 4.7915H5.00002C5.34169 4.7915 5.62502 5.07484 5.62502 5.4165C5.62502 5.75817 5.34169 6.0415 5.00002 6.0415Z"
              fill="white"
            />
            <path
              d="M8.33335 8.95833C7.39472 8.95613 6.49516 8.58229 5.83145 7.91857C5.16773 7.25486 4.79389 6.3553 4.79169 5.41667C4.79389 4.47803 5.16773 3.57848 5.83145 2.91476C6.49516 2.25105 7.39472 1.8772 8.33335 1.875C9.27199 1.8772 10.1715 2.25105 10.8353 2.91476C11.499 3.57848 11.8728 4.47803 11.875 5.41667C11.8728 6.3553 11.499 7.25486 10.8353 7.91857C10.1715 8.58229 9.27199 8.95613 8.33335 8.95833ZM8.33335 3.125C7.06669 3.125 6.04169 4.15 6.04169 5.41667C6.04169 6.68333 7.06669 7.70833 8.33335 7.70833C9.60002 7.70833 10.625 6.68333 10.625 5.41667C10.625 4.15 9.60002 3.125 8.33335 3.125Z"
              fill="white"
            />
            <path
            ...
            />
            <path
              d="M6.66669 15.2085H1.66669C1.32502 15.2085 1.04169 14.9252 1.04169 14.5835C1.04169 14.2418 1.32502 13.9585 1.66669 13.9585H6.66669C7.00835 13.9585 7.29169 14.2418 7.29169 14.5835C7.29169 14.9252 7.00835 15.2085 6.66669 15.2085Z"
              fill="white"
            />
            <path
        ...
        <div className={"filter-box-search"}>
          ...
          {tableFilterData.selects && (
            <div className={"filter-box-selects"}>
              {tableFilterData.selects
                .filter((select) => select.name !== headerList?.name && select.name)
                .map((select) => (
                  <Input
                    key={select.name}
