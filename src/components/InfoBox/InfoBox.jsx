    ...
    return (
        <div className={`card ${props.bg} ${props.center} ${props.height} ${props.padding} ${props.rewardbox} ${props.anime}`}>
            {props.type === "avilable" ? (
                ...
                <h1 className={`card-header-detail anime-astaring-pos ${props.anime}`}>{props.header.title}</h1>
                    ...
                    return (
                        <div className={`card-body display-flex anime-astaring-pos ${props.anime}`}>
                            <div className='display-flex'>
                                ...
                                <div className={`list-group-item font-bigger anime-astaring-two ${props.anime}`}>{item.title}</div>
                            </div>
                            <p className={`list-group-item font-bigger anime-astaring-pos-three ${props.anime}`}>{item.amount}</p>
                        </div>
                    )
                })
            ) : ""
            ...
            {props.type === "avilable" ? (
                ...
                props.cardBody.map((item) => {
                    return (
                        <div className={`card-body-unavilable anime-astaring-pos-two ${props.anime}`}>
                ...
                <div className={`connec-tWallet-Body`}>
                    <p className={`anime-astaring-pos-two ${props.anime}`}>Connect your Ethereum wallet to deposit funds & start trading.</p>
                    <div className={`anime-astaring-pos-three ${props.anime}`}>
            ...
            {props.type === "unAvilable" ? (
                <div className={`Unavailable-button anime-astaring-pos-three ${props.anime}`}>Unavailable</div>
            ) : ""}
        </div>
    )
}
