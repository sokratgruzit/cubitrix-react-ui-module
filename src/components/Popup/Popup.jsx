          ...
          <div style={addTokenCustomStyles} className="pop-body">
            <div className="body-row sc">
              <Input
                ...
                onChange={(e) =>
                  addTokenHandlerDataUpdate(e.target.value, "tranxType")
                }
              />
              {/* <Input
                        type={"default"}
              ...
              <Input
                ...
                onChange={(e) =>
                  addTokenHandlerDataUpdate(e.target.value, "tranxDate")
                }
                label={"Tranx Date"}
                customStyles={{ width: "calc(50% - 10px)" }}
              />
            ...
            <div className="body-row sc">
              <Input
                ...
                subLabel={""}
                onChange={(e) =>
                  addTokenHandlerDataUpdate(e.target.value, "tokenAddedTo")
                }
                customStyles={{ width: "calc(50% - 10px)" }}
              />
              <Input
                ...
                subLabel={""}
                onChange={(e) =>
                  addTokenHandlerDataUpdate(e.target.value, "tokenForStage")
                }
                customStyles={{ width: "calc(50% - 10px)" }}
              />
            </div>
            <div className="body-row sc">
              <Input
                ...
                subLabel={""}
                onChange={(e) =>
                  addTokenHandlerDataUpdate(e.target.value, "paymentGateway")
                }
                customStyles={{ width: "calc(50% - 10px)" }}
              />
              <Input
                ...
                subLabel={""}
                onChange={(e) =>
                  addTokenHandlerDataUpdate(e.target.value, "paymentAmount")
                }
                customStyles={{ width: "calc(50% - 10px)" }}
              />
            </div>
            <div className="body-row">
              <Input
                ...
                subLabel={""}
                onChange={(e) =>
                  addTokenHandlerDataUpdate(e.target.value, "paymentAddress")
                }
            ...
            <div className="body-row">
              <Input
                ...
                subLabel={""}
                onChange={(e) =>
                  addTokenHandlerDataUpdate(e.target.value, "numberToken")
                }
                customStyles={{ width: "calc(50% - 10px)" }}
              />
        ...
        {type === "addAdmin" && (
          <div className={`addAdmin-container`}>
            <Input
              ...
              selectHandler={(opt) =>
                handleAddAdminSelectChange(opt, addAdminSelect.value)
              }
