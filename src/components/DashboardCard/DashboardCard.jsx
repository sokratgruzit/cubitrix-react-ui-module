...
export const DashboardCard = ({ 
  ...
  return (
    <div>
        {type === 'sale-card' && (
            <div className={'card-container sale-card'}>
        ...
        {type === 'amount-card' && (
            <div className={'card-container amount-card'}>
                <div className={'card-header'}>
                    <p className={'font-14'}>{cardHeader}</p>
                    <div className={'card-header__buttons'}>
                        {cardHeaderButtons?.map((item, index) => (
                ...
                <div>
                    ...
                    <p className={'amount-card__usdt font-12'}>
                        ...
                        <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M2.66602 8.49984C2.66602 5.56565 5.06517 3.1665 7.99935 3.1665C10.9335 3.1665 13.3327 5.56565 13.3327 8.49984C13.3327 11.434 10.9335 13.8332 7.99935 13.8332C5.06517 13.8332 2.66602 11.434 2.66602 8.49984ZM7.99935 3.91069C5.47617 3.91069 3.4102 5.97666 3.4102 8.49984C3.4102 11.023 5.47617 13.089 7.99935 13.089C10.5225 13.089 12.5885 11.023 12.5885 8.49984C12.5885 5.97666 10.5225 3.91069 7.99935 3.91069Z" fill="#6A6D76"/>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M7.999 10.9805C7.7935 10.9805 7.62691 10.8139 7.62691 10.6084L7.62691 8.12776C7.62691 7.92225 7.7935 7.75566 7.999 7.75566C8.2045 7.75566 8.37109 7.92225 8.37109 8.12776L8.37109 10.6084C8.37109 10.8139 8.2045 10.9805 7.999 10.9805Z" fill="#6A6D76"/>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M8.49805 6.63962C8.49805 6.91362 8.27592 7.13574 8.00192 7.13574L7.99746 7.13574C7.72346 7.13574 7.50133 6.91362 7.50133 6.63962C7.50133 6.36562 7.72346 6.14349 7.99746 6.14349L8.00192 6.14349C8.27592 6.14349 8.49805 6.36562 8.49805 6.63962Z" fill="#6A6D76"/>
                        </svg>
                    </p>
                </div>
