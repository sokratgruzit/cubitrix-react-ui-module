...
export const Referral = ({
  ...
  const [referralTreeTableDataBody, setReferralTreeTableDataBody] = useState(null);
  ...
  useEffect(() => {
    if(referralTableType == 'binary') {
      let html = referralTreeTableData?.map((item, index) => {
        return (
            <div
      ...
      setReferralTreeTableDataBody(html)
    }
          ...
          <div className='referral-binary-wrapper'>
            <div className='referral-table-container'>
              <Table
                  ...
                  tableData={referralTreeTableDataBody}
