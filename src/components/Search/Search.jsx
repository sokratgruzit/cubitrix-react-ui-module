...
export const Search = (props) => {
  ...
  return (
    <div className={'transactions-search-container'}>
        <div className={showSearchBox || showResultBox ? 'search-box-container show-search' : 'search-box-container'}>
            <div className={'search-box-list font-14'}>
                {props.searchData.map(item => (
                    <div 
                        key={item}
                        className={item.active ? 'search-box-list__item list-item__active' : 'search-box-list__item'}
        ...
        {showSearchBox && (
            <div className={'transactions-search'}>
                <div className={'transactions-search-input'}>
                    ...
                    />
                    <div 
                        className={'transactions-input-btn font-14'}
                        onClick={() => console.log('transaction')}
                    >
                        Transaction
                    </div>
                </div>
                <div className={'transactions-selects-container'}>
                    <Input
                        type={"default"}
                        icon={false}
                        label={'Tranx Type'}
