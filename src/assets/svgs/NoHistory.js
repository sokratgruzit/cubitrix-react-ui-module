  ...
  return (
    ...
    >
      <path
        ...
        fill="#796AD4"
      />
      <circle cx="95" cy="6" r="2" fill="#c38c5c" fillOpacity="0.6" />
      <circle cx="88" cy="67" r="2" fill="#c38c5c" fillOpacity="0.4" />
      <circle cx="10.5" cy="62.5" r="2.5" fill="#c38c5c" fillOpacity="0.4" />
      <circle cx="13.5" cy="18.5" r="1.5" fill="#c38c5c" fillOpacity="0.8" />
      <circle cx="15" cy="57" r="1" fill="#c38c5c" fillOpacity="0.6" />
      <path
